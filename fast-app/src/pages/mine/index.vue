<template>
	...
	<view class="cover-container" :style="[
		...
		<view class="order-section">
			...
			<view class="order-item" @click="navTo('/pages/order/order?status=101')" hover-class="common-hover"
				:hover-stay-time="50">
				<text class="yticon icon-daifukuan"></text>
				<text>待付款</text>
			</view>
			<view class="order-item" @click="navTo('/pages/order/order?state=301')" hover-class="common-hover"
				:hover-stay-time="50">
				<text class="yticon icon-yishouhuo"></text>
				<text>待发货</text>
			</view>
			<view class="order-item" @click="navTo('/pages/order/order?state=901')" hover-class="common-hover"
				:hover-stay-time="50">
		...
		<view class="history-section icon">
			...
			<scroll-view scroll-x class="h-list">
				<image @click="navTo('/pages/product/product')"
					src="https://www.youlai.tech/files/default/d97457b3fd7d4aef8846da96fe032bf8.jpg" mode="aspectFill">
				</image>
				<image @click="navTo('/pages/product/product')"
					src="http://a.youlai.tech:9000/default/8815c9a46fcc4b1ea952623406750da5.jpg" mode="aspectFill">
				</image>
				<image @click="navTo('/pages/product/product')"
					src="https://www.youlai.tech/files/default/835d73a337964b9b97e5c7c90acc8cb2.png" mode="aspectFill">
				</image>
				<image @click="navTo('/pages/product/product')"
					src="https://oss.youlai.tech/default/0ccd5bf5cf384185be1f18a01da076b9.png" mode="aspectFill">
				</image>
...
import { ref } from 'vue';
	...
	let {
		token,
		userObj
	} = toRefs(proxy.$store.user.useUserStore());
	...
	async function bind(e) {
		console.log(e)
		if (e.detail.iv) {
			await proxy.$store.user.useUserStore().bind(e.detail.iv, e.detail.encryptedData);
		}
	}
	...
	function coverTouchstart(e) {
		...
		coverTransition.value = 'transform .1s/notice/notice linear';
