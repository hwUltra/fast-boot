...
import { MenuQuery, MenuForm, MenuVO } from "@/api/sys/menu/types";
import {
  listMenus,
  getMenuForm,
  getMenuOptions,
  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item v-if="formData.type != 4" prop="visible" label="显示状态">
        ...
        <el-form-item v-if="formData.type == 2" label="根目录始终显示">
          <template #label>
            <div>
              根目录始终显示
        ...
        <el-form-item v-if="formData.type == 2" label="跳转路由">
