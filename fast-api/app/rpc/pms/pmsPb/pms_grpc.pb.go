...
func (c *pmsClient) ShopPage(ctx context.Context, in *PageReq, opts ...grpc.CallOption) (*ShopPageResp, error) {
	...
	err := c.cc.Invoke(ctx, Pms_ShopPage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pmsClient) PmsBrandPage(ctx context.Context, in *PmsBrandPageReq, opts ...grpc.CallOption) (*PmsBrandPageResp, error) {
	...
	err := c.cc.Invoke(ctx, Pms_PmsBrandPage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pmsClient) PmsGoodsPage(ctx context.Context, in *PmsGoodsPageReq, opts ...grpc.CallOption) (*PmsGoodsPageResp, error) {
	...
	err := c.cc.Invoke(ctx, Pms_PmsGoodsPage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
